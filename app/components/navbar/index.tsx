          ...
          {isAboveMediaScreens ? (
            <div className={`${flexBetween} gap-8 text-sm text-white`}>
              ...
              <Link
                ...
                setSelectedPage={setSelectedPage}
              />
              <p className="transition duration-300 text-base hover:text-white cursor-pointer" onClick={() => router.push("/properties")}>Products</p>
            </div>
          ) : (
            <button
        ...
        <div className="fixed right-0 bottom-0 z-40 h-full w-[300px] bg-alice-blue drop-shadow-xl">
          ...
          <div className={`flex flex-col gap-10 ml-[33%] text-2xl text-white`}>
            ...
            <Link
              ...
              setSelectedPage={setSelectedPage}
            />
            <p className="transition duration-300 text-base hover:text-white cursor-pointer" onClick={() => router.push("/properties")}>Properties</p>
            <Link
              page="Contact Us"
              selectedPage={selectedPage}
              setSelectedPage={setSelectedPage}
